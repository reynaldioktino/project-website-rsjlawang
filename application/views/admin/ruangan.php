...
<script type="text/javascript">
    $(document).ready(function(){  
        ...
        var tableajax = $('#myTable').DataTable({
          responsive: true,
            ajax: '<?php echo base_url("C_ruangan/getAjax") ?>',
            columns: [
             { 
                data: null,
             ...
             { data: 'kapasitas' },
             {
              data: null,
              render: function ( data, type, row ) {
                var ret = '<a href="javascript:;" class="btn btn-info btn-sm item_edit" data="'+row.id_ruangan+'">Update</a>';
                ret+= '<a href="javascript:;" class="btn btn-danger btn-sm item_hapus" data="'+row.id_ruangan+'">Delete</a>';
                return ret;
               }
             }
             ]
        ...
        $('#btn_simpan').on('click',function(){
            var id_ruangan=$('#id_ruangan1').val();
            var nama=$('#nama1').val();
            var kapasitas=$('#kapasitas1').val();
            $.ajax({
                type : "POST",
                url  : "<?php echo base_url('C_ruangan/add')?>",
                dataType : "JSON",
                data : {id_ruangan:id_ruangan , nama:nama, kapasitas:kapasitas},
                success: function(data){
                    $('[name="id_ruangan_add"]').val("");
                    $('[name="nama_add"]').val("");
                    $('[name="kapasitas_add"]').val("");
                    $('#ModalAdd').modal('hide');
                    // tampil_data();
                    rownumber=0;
        ...
        $('#show_data').on('click','.item_edit',function(){
            ...
            $.ajax({
                type : "GET",
                url  : "<?php echo base_url('C_ruangan/where')?>",
                dataType : "JSON",
                data : {id:id},
                success: function(data){
                    $.each(data,function(id_ruangan, nama, kapasitas){
                        $('#ModalUpdate').modal('show');
                        $('[name="id_ruangan_edit"]').val(data.id_ruangan);
                        $('[name="nama_edit"]').val(data.nama);
                        $('[name="kapasitas_edit"]').val(data.kapasitas);
                    });
                }
            });
            return false;
        ...
        $('#btn_update').on('click',function(){
            ...
            var nama=$('#nama2').val();
            var kapasitas=$('#kapasitas2').val();
            $.ajax({
                type : "POST",
                url  : "<?php echo base_url('C_ruangan/update')?>",
                dataType : "JSON",
                data : {id_ruangan:id_ruangan , nama:nama, kapasitas:kapasitas},
                success: function(data){
                    $('[name="id_ruangan_edit"]').val("");
                    $('[name="nama_edit"]').val("");
                    $('[name="kapasitas_edit"]').val("");
        ...
        $('#btn_hapus').on('click',function(){
            ...
            $.ajax({
                type : "POST",
                url  : "<?php echo base_url('C_ruangan/delete')?>",
                dataType : "JSON",
                data : {kode: kode},
                success: function(data){
