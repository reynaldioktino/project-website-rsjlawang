...
<script type="text/javascript">
    $(document).ready(function(){  
        ...
        var tableajax = $('#myTable').DataTable({
          responsive: true,
            ajax: '<?php echo base_url("C_obat/getAjax") ?>',
            columns: [
             { 
                data: null,
        ...
        $('#btn_simpan').on('click',function(){
            ...
            $.ajax({
                type : "POST",
                url  : "<?php echo base_url('C_obat/add')?>",
                dataType : "JSON",
                data : {nama:nama},
        ...
        $('#show_data').on('click','.item_edit',function(){
            ...
            $.ajax({
                type : "GET",
                url  : "<?php echo base_url('C_obat/where')?>",
                dataType : "JSON",
                data : {id:id},
                success: function(data){
        ...
        $('#btn_update').on('click',function(){
            ...
            $.ajax({
                type : "POST",
                url  : "<?php echo base_url('C_obat/update')?>",
                dataType : "JSON",
        ...
        $('#btn_hapus').on('click',function(){
            ...
            $.ajax({
                type : "POST",
                url  : "<?php echo base_url('C_obat/delete')?>",
                dataType : "JSON",
                data : {kode: kode},
                success: function(data){
