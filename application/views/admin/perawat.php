...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Data Perawat</h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
            ...
            <form class="form-horizontal">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-9">
                            <input name="id_perawat_edit" id="id_perawat2" class="form-control" type="text" required>
                        </div>
                    </div>
...
<script type="text/javascript">
    $(document).ready(function(){  
        ...
        var tableajax = $('#myTable').DataTable({
          responsive: true,
            ajax: '<?php echo base_url("C_perawat/getAjax") ?>',
            columns: [
             { 
                data: null,
             ...
             { data : 'jk'},
             {
              data: null,
              render: function ( data, type, row ) {
                var ret = '<a href="javascript:;" class="btn btn-info btn-sm item_edit" data="'+row.id_perawat+'">Update</a>';
                ret+= '<a href="javascript:;" class="btn btn-danger btn-sm item_hapus" data="'+row.id_perawat+'">Delete</a>';
                return ret;
               }
             }
             ]
        ...
        $('#btn_simpan').on('click',function(){
            var id_perawat=$('#id_perawat1').val();
            ...
            $.ajax({
                type : "POST",
                url  : "<?php echo base_url('C_perawat/add')?>",
                dataType : "JSON",
                data : {id_perawat:id_perawat, id_user:id_user, nip:nip, nama:nama, alamat:alamat, no_tlp:no_tlp, jk:jk},
        ...
        $('#show_data').on('click','.item_edit',function(){
            ...
            $.ajax({
                type : "GET",
                url  : "<?php echo base_url('C_perawat/where')?>",
                dataType : "JSON",
                data : {id:id},
                success: function(data){
                    $.each(data,function(id_perawat, id_user, nip, nama, alamat, no_tlp, jk){
        ...
        $('#btn_update').on('click',function(){
            ...
            $.ajax({
                type : "POST",
                url  : "<?php echo base_url('C_perawat/update')?>",
                dataType : "JSON",
                data : {id_perawat:id_perawat, id_user:id_user, nip:nip, nama:nama, alamat:alamat, no_tlp:no_tlp, jk:jk},
                success: function(data){
        ...
        $('#btn_hapus').on('click',function(){
            ...
            $.ajax({
                type : "POST",
                url  : "<?php echo base_url('C_perawat/delete')?>",
                dataType : "JSON",
                data : {kode: kode},
                success: function(data){
